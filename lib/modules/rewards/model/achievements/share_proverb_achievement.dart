...
class ShareProverbAchievement extends Achievement {
  ShareProverbAchievement()
      : super(
          id: RewardsType.shareProverb.index,
          level: 0,
          currentPoints: 0,
          totalPoints: 2,
          coinsRewarded: 50,
  ...
  _showAchievementDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AchievementDialog(
        ...
        //Descargar Refranes
        title: S.of(context).shareProverbsDialogTitle(currentPoints),
        ...
        description: S
            .of(context)
            .shareProverbsDialogDescription(coinsRewarded, currentPoints),
      ),
    );
  }
}
